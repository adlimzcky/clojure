...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__37688){
...
return clojure.zip.zipper((function (p1__37693_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__37693_SHARP_)) || (cljs.core.map_QMARK_(p1__37693_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__37697){
var vec__37698 = p__37697;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37698,(0),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__37708_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__37708_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37707_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__37707_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__37709_SHARP_){
return (((p1__37709_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__37709_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__37713,mapping){
var map__37714 = p__37713;
var map__37714__$1 = cljs.core.__destructure_map(map__37714);
var state = map__37714__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37714__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37714__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37714__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__37712_SHARP_){
var and__4251__auto__ = (p1__37712_SHARP_ instanceof cljs.core.Symbol);
if(and__4251__auto__){
return cljs.core.namespace(p1__37712_SHARP_);
} else {
...
var G__37794 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__37799 = clojure.zip.next(loc);
loc = G__37799;
continue;
}
}
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__37736){
var vec__37737 = p__37736;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37737,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq37734){
var G__37735 = cljs.core.first(seq37734);
var seq37734__$1 = cljs.core.next(seq37734);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37735,seq37734__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__37740_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__37740_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__37742_37821 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__37743_37822 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__37744_37823 = true;
var _STAR_print_fn_STAR__temp_val__37745_37824 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__37744_37823);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__37745_37824);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__37743_37822);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__37742_37821);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4795__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__37741_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__37741_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__37828 = cljs.core.next(opts__$1);
var G__37829 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__37828;
acc = G__37829;
continue;
} else {
if(typeof f === 'string'){
var G__37831 = cljs.core.next(opts__$1);
var G__37832 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__37831;
acc = G__37832;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__37833 = cljs.core.nnext(opts__$1);
var G__37834 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__37833;
acc = G__37834;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__37835 = cljs.core.next(opts__$1);
var G__37836 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__37835;
acc = G__37836;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__37758 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__37758.cljs$core$IFn$_invoke$arity$1 ? fexpr__37758.cljs$core$IFn$_invoke$arity$1(f) : fexpr__37758.call(null,f));
})())){
var G__37837 = cljs.core.next(opts__$1);
var G__37838 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__37837;
acc = G__37838;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__37759 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__37759.cljs$core$IFn$_invoke$arity$1 ? fexpr__37759.cljs$core$IFn$_invoke$arity$1(f) : fexpr__37759.call(null,f));
})())){
var G__37839 = cljs.core.nnext(opts__$1);
var G__37840 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__37839;
acc = G__37840;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__37841 = cljs.core.next(opts__$1);
var G__37842 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__37841;
acc = G__37842;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__37761){
var vec__37762 = p__37761;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37762,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37762,(1),null);
...
var G__37766 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__37765 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__37765.cljs$core$IFn$_invoke$arity$1 ? fexpr__37765.cljs$core$IFn$_invoke$arity$1(G__37766) : fexpr__37765.call(null,G__37766));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__37769 = quoted_form;
var G__37770 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__37769,G__37770) : day8.re_frame.debux.common.util.remove_d.call(null,G__37769,G__37770));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__37771 = quoted_form;
var G__37772 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__37771,G__37772) : day8.re_frame.debux.common.util.remove_d.call(null,G__37771,G__37772));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__37844__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__37774 = quoted_form;
var G__37775 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__37774,G__37775) : day8.re_frame.debux.common.util.remove_d.call(null,G__37774,G__37775));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__37845__i < G__37845__a.length) {G__37845__a[G__37845__i] = arguments[G__37845__i + 0]; ++G__37845__i;}
  arg = new cljs.core.IndexedSeq(G__37845__a,0,null);
} 
return G__37844__delegate.call(this,arg);};
G__37844.cljs$lang$maxFixedArity = 0;
G__37844.cljs$lang$applyTo = (function (arglist__37846){
var arg = cljs.core.seq(arglist__37846);
return G__37844__delegate(arg);
});
...
var G__37851 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__37851;
continue;
} else {
...
var G__37852 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__37852;
continue;
} else {
var G__37853 = clojure.zip.next(loc);
loc = G__37853;
continue;
