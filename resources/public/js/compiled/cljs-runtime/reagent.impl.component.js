...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23646 = c;
var G__23646__$1 = (((G__23646 == null))?null:G__23646.prototype);
if((G__23646__$1 == null)){
return null;
} else {
return G__23646__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23647 = c;
var G__23647__$1 = (((G__23647 == null))?null:G__23647.prototype);
if((G__23647__$1 == null)){
return null;
} else {
return G__23647__$1.render;
}
})() == null)))));
});
...
var or__4253__auto__ = (function (){var G__23657 = c;
var G__23657__$1 = (((G__23657 == null))?null:G__23657.constructor);
if((G__23657__$1 == null)){
return null;
} else {
return G__23657__$1.displayName;
}
})();
...
var G__23659 = c;
var G__23659__$1 = (((G__23659 == null))?null:G__23659.constructor);
if((G__23659__$1 == null)){
return null;
} else {
return G__23659__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__23663 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23664 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23664);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23663);
}});
...
var c = this;
var G__23691_23756 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__23691_23756 == null)){
} else {
reagent.ratom.dispose_BANG_(G__23691_23756);
}
...
var renders_23757 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_23758 = cljs.core.first(cljs.core.vals(renders_23757));
...
if((cljs.core.count(renders_23757) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23757))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23758)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23758], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__23731 = o;
reagent.impl.component.goog$module$goog$object.set(G__23731,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__23739 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23740 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23740);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23739);
}});
...
var vec__23741 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23741,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23741,(1),null);
...
var G__23744 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__23744 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__23744);
}
});
}),[]);
