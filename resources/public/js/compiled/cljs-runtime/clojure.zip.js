...
var G__27780 = clojure.zip.node(loc);
var fexpr__27779 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__27779.cljs$core$IFn$_invoke$arity$1 ? fexpr__27779.cljs$core$IFn$_invoke$arity$1(G__27780) : fexpr__27779.call(null,G__27780));
});
/**
...
var G__27783 = clojure.zip.node(loc);
var fexpr__27782 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var fexpr__27790 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__27790.cljs$core$IFn$_invoke$arity$2 ? fexpr__27790.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__27790.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__27796 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27796,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27796,(1),null);
var vec__27799 = clojure.zip.children(loc);
...
var vec__27802 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27802,(0),null);
var map__27805 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27802,(1),null);
var map__27805__$1 = cljs.core.__destructure_map(map__27805);
var path = map__27805__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27805__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27805__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27805__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27805__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27805__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__27806 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27806,(0),null);
var map__27809 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27806,(1),null);
var map__27809__$1 = cljs.core.__destructure_map(map__27809);
var path = map__27809__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27809__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__27810 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27809__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__27814 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27814,(0),null);
var map__27817 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27814,(1),null);
var map__27817__$1 = cljs.core.__destructure_map(map__27817);
var path = map__27817__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27817__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27817__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return r;
} else {
...
var vec__27819 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27819,(0),null);
var map__27822 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27819,(1),null);
var map__27822__$1 = cljs.core.__destructure_map(map__27822);
var path = map__27822__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27822__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27822__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
...
var vec__27825 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27825,(0),null);
...
var path = map__27828__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27828__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27828__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__27829 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27829,(0),null);
var map__27832 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27829,(1),null);
var map__27832__$1 = cljs.core.__destructure_map(map__27832);
var path = map__27832__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27832__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__27833 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27833,(0),null);
var map__27836 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27833,(1),null);
var map__27836__$1 = cljs.core.__destructure_map(map__27836);
var path = map__27836__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27836__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27837,(1),null);
...
var len__4864__auto___27854 = arguments.length;
var i__4865__auto___27855 = (0);
while(true){
if((i__4865__auto___27855 < len__4864__auto___27854)){
args__4870__auto__.push((arguments[i__4865__auto___27855]));

var G__27856 = (i__4865__auto___27855 + (1));
i__4865__auto___27855 = G__27856;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq27840){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27841,G__27842,seq27840__$2);
}));
...
var G__27861 = clojure.zip.rightmost(child);
loc__$1 = G__27861;
continue;
} else {
return loc__$1;
...
var vec__27843 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27843,(0),null);
var map__27846 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27843,(1),null);
var map__27846__$1 = cljs.core.__destructure_map(map__27846);
var path = map__27846__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27846__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27846__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27846__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27846__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__27867 = clojure.zip.rightmost(child);
loc__$1 = G__27867;
continue;
} else {
return loc__$1;
