...
var i_32076 = (0);
while(true){
if((i_32076 < arr.length)){
(arr[i_32076] = null);

var G__32077 = (i_32076 + (1));
i_32076 = G__32077;
continue;
} else {
}
...
var i_32090 = (self__.level + (1));
while(true){
if((i_32090 <= (new_level + (1)))){
(update[i_32090] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32092 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32092[i]));
} else {
x__$2.forward.push((((i < links_32092.length))?(links_32092[i]):null));
}

if((i < links_32092.length)){
(links_32092[i] = x__$2);
} else {
links_32092.push(x__$2);
}
...
var i_32098 = (0);
while(true){
if((i_32098 <= self__.level)){
var links_32099 = (update[i_32098]).forward;
if((x__$1 === (((i_32098 < links_32099.length))?(links_32099[i_32098]):null))){
(links_32099[i_32098] = (x__$1.forward[i_32098]));

var G__32100 = (i_32098 + (1));
i_32098 = G__32100;
continue;
} else {
var G__32101 = (i_32098 + (1));
i_32098 = G__32101;
continue;
}
} else {
...
var G__32106 = nx;
var G__32107 = (level__$1 - (1));
x = G__32106;
level__$1 = G__32107;
continue;
} else {
var G__32108 = x;
var G__32109 = (level__$1 - (1));
x = G__32108;
level__$1 = G__32109;
continue;
}
