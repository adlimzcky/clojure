...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_22211 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_22211(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22212 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22212(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22213 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22213(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22214 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22214(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22216 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22216(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22220 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22220(reader);
}
});
...
var G__22252 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__22253 = s.append(c);
c = G__22252;
s = G__22253;
continue;
}
