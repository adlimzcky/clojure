...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__27924,k,f){
var vec__27925 = p__27924;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27925,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27925,(1),null);
var loc = vec__27925;
...
var G__27954 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__27954;
continue;
}
break;
...
var G__27955 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__27955;
continue;
} else {
return zloc__$1;
...
var G__27956 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__27956;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__27935){
var vec__27936 = p__27935;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27936,(0),null);
var map__27939 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27936,(1),null);
var map__27939__$1 = cljs.core.__destructure_map(map__27939);
var path = map__27939__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27939__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__27936;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__27942){
var vec__27944 = p__27942;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27944,(0),null);
var map__27947 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27944,(1),null);
var map__27947__$1 = cljs.core.__destructure_map(map__27947);
var path = map__27947__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27947__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__27944;
if(cljs.core.seq(r)){
...
var vec__27950 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27950,(0),null);
var map__27953 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27950,(1),null);
var map__27953__$1 = cljs.core.__destructure_map(map__27953);
var path = map__27953__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27953__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27953__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27953__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27953__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
