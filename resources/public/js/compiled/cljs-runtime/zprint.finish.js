...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__26231_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__26231_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__26231_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__26239){
var vec__26240 = p__26239;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26240,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26240,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__26243,s,color,element,idx){
var map__26244 = p__26243;
var map__26244__$1 = cljs.core.__destructure_map(map__26244);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26244__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26244__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26244__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__26247 = (function (){var or__4253__auto__ = color;
...
var fexpr__26246 = (function (){var G__26248 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__26248) : style_map.call(null,G__26248));
})();
return (fexpr__26246.cljs$core$IFn$_invoke$arity$1 ? fexpr__26246.cljs$core$IFn$_invoke$arity$1(G__26247) : fexpr__26246.call(null,G__26247));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__26249){
var vec__26250 = p__26249;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26250,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26250,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26250,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__26253){
var vec__26254 = p__26253;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26254,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26254,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26254,(2),null);
...
var G__26322 = cljs.core.next(ssv);
var G__26323 = (this_ssv == null);
var G__26324 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__26325 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__26322;
doing_nil_QMARK_ = G__26323;
last_elide = G__26324;
out = G__26325;
continue;
}
...
var vec__26260 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26260,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26260,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26260,(2),null);
...
var G__26326 = cljs.core.next(remaining_cvec);
var G__26327 = new_idx;
var G__26328 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__26326;
idx = G__26327;
out = G__26328;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__26269,cursor_vec){
var vec__26270 = p__26269;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26270,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26270,(1),null);
var focus_vec = vec__26270;
...
var vec__26273 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26273,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26273,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__26277){
var vec__26279 = p__26277;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26279,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26279,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__26287,existing_count){
var vec__26288 = p__26287;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26288,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26288,(1),null);
...
return cljs.core.filterv((function (p1__26284_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__26284_SHARP_))));
...
var vec__26298 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26298,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26298,(1),null);
var cvec_element = vec__26298;
if((cvec_element == null)){
var G__26338 = cljs.core.next(cvec_nl);
var G__26339 = (idx + (1));
var G__26340 = start;
var G__26341 = out;
cvec_nl = G__26338;
...
var G__26342 = cljs.core.next(cvec_nl);
var G__26343 = (idx + (1));
var G__26344 = idx;
var G__26345 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__26342;
idx = G__26343;
start = G__26344;
out = G__26345;
...
var G__26347 = cljs.core.next(cvec_nl);
var G__26348 = (idx + (1));
var G__26349 = (idx + (1));
var G__26350 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__26347;
idx = G__26348;
start = G__26349;
out = G__26350;
...
var G__26351 = cljs.core.next(cvec_nl);
var G__26352 = (idx + (1));
var G__26353 = idx;
var G__26354 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__26351;
idx = G__26352;
start = G__26353;
out = G__26354;
...
var G__26355 = cljs.core.next(cvec_nl);
var G__26356 = (idx + (1));
var G__26357 = start;
var G__26358 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__26355;
idx = G__26356;
start = G__26357;
out = G__26358;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__26303_SHARP_,p2__26302_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__26302_SHARP_)){
return cljs.core.reduced(p1__26303_SHARP_);
} else {
return (p1__26303_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__26305,p__26306){
var vec__26307 = p__26305;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26307,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26307,(1),null);
var vec__26310 = p__26306;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26310,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26310,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__26316,cvec,focus_vec){
var map__26317 = p__26316;
var map__26317__$1 = cljs.core.__destructure_map(map__26317);
var options = map__26317__$1;
var map__26318 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26317__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__26318__$1 = cljs.core.__destructure_map(map__26318);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26318__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26318__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26318__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26315_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__26315_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
