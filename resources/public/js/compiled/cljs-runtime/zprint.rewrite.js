...
var G__28213 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__28213;
continue;
} else {
var G__28214 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__28214;
continue;
}
} else {
var G__28215 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__28215;
continue;
}
}
...
var G__28193 = zloc;
var G__28194 = (function (){var G__28195 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__28196 = zloc;
var G__28196__$1 = (((G__28196 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__28196) : rewrite_clj.zip.node.call(null,G__28196)));
if((G__28196__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__28196__$1) : zprint.zutil.edn_STAR_.call(null,G__28196__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__28195) : rewrite_clj.zip.root.call(null,G__28195));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__28193,G__28194) : rewrite_clj.zip.replace.call(null,G__28193,G__28194));
});
/**
...
var G__28220 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__28220;
continue;
}
break;
...
var G__28221 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__28222 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__28221;
out = G__28222;
continue;
} else {
...
var G__28224 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__28225 = cljs.core.next(new_loc);
var G__28226 = replaced_loc;
nloc = G__28224;
new_loc = G__28225;
last_loc = G__28226;
continue;
...
return zprint.rewrite.sort_val((function (){var G__28204 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__28204) : rewrite_clj.zip.down.call(null,G__28204));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__28205_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__28205_SHARP_) : rewrite_clj.zip.tag.call(null,p1__28205_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__28205_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__28205_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
