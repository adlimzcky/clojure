...
var map__16201 = top_item;
var map__16201__$1 = cljs.core.__destructure_map(map__16201);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16201__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16201__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16201__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5751__auto___16212 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___16212)){
var seen_errors_16213 = temp__5751__auto___16212;
if(cljs.core.truth_(seen_errors_16213.has(self))){
} else {
seen_errors_16213.add(self);

var temp__5753__auto___16214 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___16214)){
var sense_16215 = temp__5753__auto___16214;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_16215)].join(''));
} else {
}
}
} else {
