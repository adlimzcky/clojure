...
if((c === "\n")){
var G__27691 = escape_QMARK_;
var G__27692 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__27691;
lines = G__27692;
continue;
} else {
buf.append(c);

var G__27693 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__27694 = lines;
escape_QMARK_ = G__27693;
lines = G__27694;
continue;
...
var G__27686 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__27686) : rewrite_clj.node.string_node.call(null,G__27686));
});
...
var G__27687 = cljs.core.re_pattern(regex);
var G__27688 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__27687,G__27688) : rewrite_clj.node.token_node.call(null,G__27687,G__27688));
});
