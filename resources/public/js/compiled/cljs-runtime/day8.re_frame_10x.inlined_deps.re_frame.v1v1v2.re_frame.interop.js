...
return [(function (){var pred__20173 = cljs.core.instance_QMARK_;
var expr__20174 = reactive_val;
if(cljs.core.truth_((pred__20173.cljs$core$IFn$_invoke$arity$2 ? pred__20173.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__20174) : pred__20173.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__20174)))){
return "ra";
} else {
if(cljs.core.truth_((pred__20173.cljs$core$IFn$_invoke$arity$2 ? pred__20173.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__20174) : pred__20173.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__20174)))){
return "rc";
} else {
if(cljs.core.truth_((pred__20173.cljs$core$IFn$_invoke$arity$2 ? pred__20173.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__20174) : pred__20173.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__20174)))){
return "rx";
} else {
if(cljs.core.truth_((pred__20173.cljs$core$IFn$_invoke$arity$2 ? pred__20173.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__20174) : pred__20173.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__20174)))){
return "tr";
} else {
return "other";
}
