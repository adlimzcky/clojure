...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k27334,else__4505__auto__){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__27333){
var self__ = this;
var G__27333__$1 = this;
return (new cljs.core.RecordIter((0),G__27333__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this27335,other27336){
var self__ = this;
var this27335__$1 = this;
return (((!((other27336 == null)))) && ((((this27335__$1.constructor === other27336.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27335__$1.tag,other27336.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27335__$1.wrap_fn,other27336.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27335__$1.wrap_length,other27336.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27335__$1.seq_fn,other27336.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27335__$1.children,other27336.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27335__$1.__extmap,other27336.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__27377 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__27377) : self__.seq_fn.call(null,G__27377));
}));
...
var self__ = this;
var this$__$1 = this;
var G__27379 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__27379) : self__.wrap_fn.call(null,G__27379));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k27334){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__27333){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__27403 = cljs.core.keyword_identical_QMARK_;
var expr__27404 = k__4511__auto__;
if(cljs.core.truth_((pred__27403.cljs$core$IFn$_invoke$arity$2 ? pred__27403.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__27404) : pred__27403.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__27404)))){
return (new rewrite_clj.node.seq.SeqNode(G__27333,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27403.cljs$core$IFn$_invoke$arity$2 ? pred__27403.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__27404) : pred__27403.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__27404)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__27333,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27403.cljs$core$IFn$_invoke$arity$2 ? pred__27403.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__27404) : pred__27403.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__27404)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__27333,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27403.cljs$core$IFn$_invoke$arity$2 ? pred__27403.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__27404) : pred__27403.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__27404)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__27333,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27403.cljs$core$IFn$_invoke$arity$2 ? pred__27403.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__27404) : pred__27403.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__27404)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__27333,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__27333),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__27333){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__27333,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__27337){
var extmap__4542__auto__ = (function (){var G__27409 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__27337,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__27337)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__27409);
} else {
return G__27409;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__27337),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__27337),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__27337),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__27337),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__27337),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__27411_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__27411_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__27414_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__27414_SHARP_);
}),children);
});
