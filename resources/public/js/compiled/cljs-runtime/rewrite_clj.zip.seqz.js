...
var G__27981 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__27981__$1 = (((G__27981 == null))?null:cljs.core.iterate((function (loc){
...
var G__27981__$2 = (((G__27981__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__27981__$1));
var G__27981__$3 = (((G__27981__$2 == null))?null:cljs.core.last(G__27981__$2));
if((G__27981__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__27981__$3);
}
} else {
return zloc;
}
...
var G__27984 = rewrite_clj.zip.move.right(v);
var G__27985 = rewrite_clj.zip.move.up(v);
loc = G__27984;
parent = G__27985;
continue;
} else {
var G__27986 = rewrite_clj.zip.move.right(v0);
var G__27987 = parent;
loc = G__27986;
parent = G__27987;
continue;
...
var G__27988 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__27989 = rewrite_clj.zip.move.up(v);
loc = G__27988;
parent = G__27989;
continue;
} else {
var G__27990 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__27991 = parent;
loc = G__27990;
parent = G__27991;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__27982 = zloc;
var G__27982__$1 = (((G__27982 == null))?null:rewrite_clj.zip.move.down(G__27982));
var G__27982__$2 = (((G__27982__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__27982__$1,k));
if((G__27982__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__27982__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__27983 = rewrite_clj.zip.move.down(zloc);
var G__27983__$1 = (((G__27983 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__27983));
if((G__27983__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__27983__$1);
}
})(),k);
}
});
