...
return [(function (){var pred__23905 = cljs.core.instance_QMARK_;
var expr__23906 = reactive_val;
if(cljs.core.truth_((pred__23905.cljs$core$IFn$_invoke$arity$2 ? pred__23905.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__23906) : pred__23905.call(null,reagent.ratom.RAtom,expr__23906)))){
return "ra";
} else {
if(cljs.core.truth_((pred__23905.cljs$core$IFn$_invoke$arity$2 ? pred__23905.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__23906) : pred__23905.call(null,reagent.ratom.RCursor,expr__23906)))){
return "rc";
} else {
if(cljs.core.truth_((pred__23905.cljs$core$IFn$_invoke$arity$2 ? pred__23905.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__23906) : pred__23905.call(null,reagent.ratom.Reaction,expr__23906)))){
return "rx";
} else {
if(cljs.core.truth_((pred__23905.cljs$core$IFn$_invoke$arity$2 ? pred__23905.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__23906) : pred__23905.call(null,reagent.ratom.Track,expr__23906)))){
return "tr";
} else {
return "other";
}
