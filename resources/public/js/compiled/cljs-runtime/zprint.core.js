...
var vec__29477 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__29480 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29480,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29480,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29477,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29477,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__29493){
var vec__29495 = p__29493;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29495,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29495,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29498,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29498,(1),null);
...
var vec__29505 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29505,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29505,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29505,(2),null);
var vec__29508 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29508,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29508,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29508,(2),null);
...
var G__29511 = special_option;
var G__29511__$1 = (((G__29511 instanceof cljs.core.Keyword))?G__29511.fqn:null);
switch (G__29511__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__29518){
var vec__29519 = p__29518;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29519,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29519,(1),null);
...
var vec__29522 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29522,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29522,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29522,(2),null);
...
var vec__29528 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29528,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29528,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29528,(2),null);
var tuple = vec__29528;
...
var G__29619 = cljs.core.next(style_vec);
var G__29620 = ends_w_blanks_QMARK_;
var G__29621 = tuple;
var G__29622 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__29619;
previous_ends_w_blanks_QMARK_ = G__29620;
previous_tuple = G__29621;
out = G__29622;
continue;
}
break;
...
var vec__29534 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29534,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29534,(1),null);
...
var result = (function (){var G__29537 = zprint.core.parse_string_all_options(rest_options);
var G__29538 = zprint.core.zprint_str_internal;
var G__29539 = ":parse-string-all? call";
var G__29540 = (function (){var G__29541 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__29541) : zprint.zutil.edn_STAR_.call(null,G__29541));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__29537,G__29538,G__29539,G__29540) : zprint.core.process_multiple_forms.call(null,G__29537,G__29538,G__29539,G__29540));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__29542 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29542,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29542,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq29531){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29532,G__29533,seq29531__$2);
}));
...
var G__29639 = (i__4865__auto___29638 + (1));
i__4865__auto___29638 = G__29639;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq29546){
var G__29547 = cljs.core.first(seq29546);
var seq29546__$1 = cljs.core.next(seq29546);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29547,seq29546__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___29644 = arguments.length;
var i__4865__auto___29645 = (0);
while(true){
if((i__4865__auto___29645 < len__4864__auto___29644)){
args__4870__auto__.push((arguments[i__4865__auto___29645]));

var G__29646 = (i__4865__auto___29645 + (1));
i__4865__auto___29645 = G__29646;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq29548){
var G__29549 = cljs.core.first(seq29548);
var seq29548__$1 = cljs.core.next(seq29548);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29549,seq29548__$1);
}));
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq29550){
var G__29551 = cljs.core.first(seq29550);
var seq29550__$1 = cljs.core.next(seq29550);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29551,seq29550__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___29654 = arguments.length;
var i__4865__auto___29655 = (0);
while(true){
if((i__4865__auto___29655 < len__4864__auto___29654)){
args__4870__auto__.push((arguments[i__4865__auto___29655]));

var G__29656 = (i__4865__auto___29655 + (1));
i__4865__auto___29655 = G__29656;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq29553){
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__29558,form){
var vec__29559 = p__29558;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29559,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29559,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29559,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29559,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__29562 = (cljs.core.truth_((function (){var and__4251__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4251__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29562,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29562,(1),null);
...
var G__29670 = cljs.core.next(sos);
var G__29671 = comment_QMARK_;
var G__29672 = (function (){var or__4253__auto__ = (!(empty_string_QMARK_));
if(or__4253__auto__){
return or__4253__auto__;
} else {
...
var G__29673 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__29670;
previous_comment_QMARK_ = G__29671;
start_interpolating_QMARK_ = G__29672;
out = G__29673;
continue;
}
break;
...
try{var vec__29577 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29577,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29577,(1),null);
...
var vec__29580 = (cljs.core.truth_((function (){var or__4253__auto__ = range_start__$1;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29580,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29580,(1),null);
...
var vec__29583 = (cljs.core.truth_((function (){var and__4251__auto__ = actual_start;
if(cljs.core.truth_(and__4251__auto__)){
return actual_end;
} else {
return and__4251__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(2),null);
...
var forms = (function (){var G__29595 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__29595) : zprint.zutil.edn_STAR_.call(null,G__29595));
})();
