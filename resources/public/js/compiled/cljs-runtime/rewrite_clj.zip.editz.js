...
var G__27959 = (function (){var G__27960 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__27960) : f.call(null,G__27960));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__27959) : rewrite_clj.node.coerce.call(null,G__27959));
});
/**
...
var len__4864__auto___27976 = arguments.length;
var i__4865__auto___27977 = (0);
while(true){
if((i__4865__auto___27977 < len__4864__auto___27976)){
args__4870__auto__.push((arguments[i__4865__auto___27977]));

var G__27978 = (i__4865__auto___27977 + (1));
i__4865__auto___27977 = G__27978;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__27961_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__27961_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq27962){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27963,G__27964,seq27962__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__27968 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__27968) : str_fn.call(null,G__27968));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__27969 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__27969) : str_fn.call(null,G__27969));
})()):null)));
...
var G__27973 = rewrite_clj.zip.base.tag(zloc);
var G__27973__$1 = (((G__27973 instanceof cljs.core.Keyword))?G__27973.fqn:null);
switch (G__27973__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__27970_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__27970_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__27971_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__27971_SHARP_)].join('');
}));
}
}));
...
var G__27975 = rewrite_clj.zip.base.tag(zloc);
var G__27975__$1 = (((G__27975 instanceof cljs.core.Keyword))?G__27975.fqn:null);
switch (G__27975__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__27974_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__27974_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
