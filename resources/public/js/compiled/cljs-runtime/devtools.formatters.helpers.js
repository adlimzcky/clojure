...
var G__18884 = devtools.prefs.pref(v);
v = G__18884;
continue;
} else {
return v;
...
}catch (e18843){var _e__16135__auto__ = e18843;
return false;
}})();
...
}catch (e18846){var _e__16135__auto__ = e18846;
return false;
}})();
...
}catch (e18848){var _e__16135__auto__ = e18848;
return false;
}}
}
});
...
var vec__18859 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18859,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18859,(1),null);
...
return cljs.core.some((function (p1__18863_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__18863_SHARP_);
}),template);
});
