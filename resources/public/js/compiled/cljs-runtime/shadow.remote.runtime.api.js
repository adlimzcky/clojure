...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35089 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35089(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_35090 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_35090(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_35094 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_35094(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_35096 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_35096(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35101 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35101(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35114 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35114(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__35052,callback){
var map__35053 = p__35052;
var map__35053__$1 = cljs.core.__destructure_map(map__35053);
var input = map__35053__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35053__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35053__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
